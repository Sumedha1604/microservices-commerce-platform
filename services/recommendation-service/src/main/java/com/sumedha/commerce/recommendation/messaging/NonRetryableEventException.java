 ...
 * fields the recommendation projection needs.
 *
 * <p>Registered with the container's {@code DefaultErrorHandler} as non-retryable, so it goes straight
 * to the dead-letter topic instead of delaying the product changes queued behind it.
 */
