...
- Product publishes catalogue changes through its transactional outbox. It deliberately does not
  call Inventory or Order; Checkout reads Product synchronously and snapshots product data into orders.
